...
public class ExceptionHandlerTest {
    ...
    void accessExcTest() {
        String error = "Test error";
        AbstractMap.SimpleEntry<String, String> expected = new AbstractMap.SimpleEntry<>("error", error);
        Map.Entry<String, String> response = exceptionHandler.handleException(new APIAccessDeniedException(error));
        assertEquals(expected, response);
    }
    ...
    void excTest() {
        String error = "Test error";
        AbstractMap.SimpleEntry<String, String> expected = new AbstractMap.SimpleEntry<>("error", error);
        Map.Entry<String, String> response = exceptionHandler.handleException(new RuntimeException(error));
        assertEquals(expected, response);
    }
}